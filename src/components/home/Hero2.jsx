...
const Hero2 = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden" style={{ background: 'linear-gradient(135deg, #d84315 0%, #bf360c 100%)' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-bold leading-tight text-white">
              ...
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-white via-yellow-300 to-white">
                customers.
              </span>
            </h1>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white text-orange-900 rounded-lg font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
            ...
            <div className="relative w-full aspect-square">
              ...
              >
                <div className="text-center">
                  <div className="text-6xl font-bold text-orange-900">92%</div>
                  <div className="text-orange-800 text-lg">SEO Analysis</div>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center">
                  <div className="text-6xl font-bold text-orange-900">95%</div>
                  <div className="text-orange-800 text-lg font-semibold">Optimization</div>
                </div>
              </motion.div>
